package uk.co.multicodetravelbooking.domain;
...
public abstract class TravelTicket {
    ...
    public TravelTicket(Long bookingRef, String origin, String destination, BigDecimal price, LocalDateTime departureTime,
